               ...
               <div className="flex-1 max-w-4xl pb-32">
                  ...
                  >
                     <div className="mb-12">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 font-google-sans">{activeTab}</h1>
                     ...
                     <div className="space-y-12">
                        <section className="bg-white/2 rounded-2xl border border-white/5 p-8 lg:p-12 overflow-hidden relative">
                           ...
                           <h3 className="text-2xl font-bold mb-6 flex items-center gap-3 font-google-sans">
